...
namespace CreatingReports
{
    public static class Reporter
    {
       ...
       /* public static void LogPassingTestStepToBugLogger(string message, string variable)
        {
            string customMessage = message + variable;
            TheLogger.Info(customMessage);
            CurrentTestCase.Log(Status.Pass, customMessage);
        } */
      ...
      /*  public static void LogTestStepForBugLogger(Status status, string message, string variable)
        {
            TheLogger.Info(message);
